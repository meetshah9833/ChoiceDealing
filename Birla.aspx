<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Birla.aspx.cs" Inherits="ChoiceDealing.Birla" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title col-lg-offset-5 col-md-offset-5 col-sm-offset-5 col-xs-offset-5">
                        <span style="margin-left: 10px"></span><span class="HeadingName">Birla Basket File</span>
                    </h4>
                            ...
                            <asp:TemplateField HeaderText="CLIENTCODE" HeaderStyle-CssClass="GridTextCenter" ItemStyle-CssClass="GridTextCenter">
                                <itemtemplate>
                                    <asp:TextBox ID="txtClientcode" runat="server" CssClass="noofBaskets"
                                        Text='<%# Eval("CLIENTCODE") %>' AutoPostBack="true" OnTextChanged="RowValueChanged">
                                    </asp:TextBox>
                                </itemtemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="TradeInstruction" HeaderStyle-CssClass="GridTextCenter" ItemStyle-CssClass="GridTextCenter">
                                <itemtemplate>
                                    <asp:TextBox ID="txtTradeInstruction" runat="server" CssClass="noofBaskets"
                                        Text='<%# Eval("TradeInstructions") %>' AutoPostBack="true" OnTextChanged="RowValueChanged">
                                    </asp:TextBox>
                                </itemtemplate>
                            </asp:TemplateField>
