<%@ Page Title="Groww Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Groww.aspx.cs" Inherits="ChoiceDealing.Groww" %>
            ...
            <div class="panel panel-default"> 
                <div class="panel-heading">
                    <h4 class="panel-title col-lg-offset-5 col-md-offset-5 col-sm-offset-5 col-xs-offset-5">
                        <span style="margin-left: 10px"></span><span class="HeadingName">Groww Basket File</span>
                    </h4>
                ...
                <div class="adjusttop container-fluid BgGridCss" style="width: 100%">
                    <asp:GridView ID="Groww_AMCReport" runat="server" AutoGenerateColumns="false" 
                        OnRowDataBound="Groww_AMCReport_RowDataBound" GridLines="Both" CellPadding="4"
                        OnRowCommand="Groww_AMCReport_RowCommand" CssClass="LabelTextCSS" Width="100%" Height="100%" Font-Size="15px">
