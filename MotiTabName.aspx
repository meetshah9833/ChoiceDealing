<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MotiTabName.aspx.cs" Inherits="ChoiceDealing.MotiTabName" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="adjusttop container-fluid BgGridCss" style="width: 100%; height: 100%; overflow-y: auto">
                    <asp:GridView ID="MotiTabNameReport" runat="server" AutoGenerateColumns="false" CssClass="LabelTextCSS" GridLines="Both" CellPadding="4" Width="100%" Height="100%">
